...
set -g @wk_menu_tpack \
'Install "i" "run-shell tpack install" \
Update "u" "run-shell tpack update" \
Clean "c" "run-shell tpack clean"'
...
'tpack "k" "show-wk-menu #{@wk_menu_tpack}" \
tpm "m" "show-wk-menu #{@wk_menu_tpm}"'
