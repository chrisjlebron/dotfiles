...
| --- | ---- | ------ | -------- | ----- | ----- |
| ZSH-001 | Create `dot_zsh_plugins_management` with Antidote bootstrap | [x] | H | chrisjlebron | New loader file |
...
| ZSH-006 | Add env toggles (LIGHT_SHELL) | [x] | M | chrisjlebron | opt-outs |
